...
_NMI_HANDLER:
	...
	cp Map_Type_Town
	jr nz, +
	ld a, (_RAM_BUILDING_INITIALIZED)
	or a
	jr nz, +
...
_LABEL_775:
	ld hl, $85E7
	ld (_RAM_C484), hl
	ld (iy+object.is_initialized), $01
...
+:
	...
	ld (ix+object.is_initialized), $01
	xor a
	ld (_RAM_C460), a
	ld (_RAM_C461), a
...
_LABEL_1F39:
	...
	ld (_RAM_FFFF), a
	ld a, $01
	ld (_RAM_BUILDING_INITIALIZED), a
	xor a
...
+:
	...
	add a, $E0
	ld (iy+object.y_position_minor), a
	ld (iy+object.is_initialized), $02
	ret
...
HandleObject_Tree_Spirit:
	...
	ld (_RAM_C504), hl
	ld a, $01
	ld (_RAM_C500+object.is_initialized), a
	ld a, $06
	ld (_RAM_C538), a
...
HandleObject_Necromancer:
	ld a, (_RAM_C500+object.is_initialized)
	or a
	jp nz, _LABEL_4278
	ld a, $30
	ld (_RAM_C500+object.x_position_minor), a
...
HandleObject_Pirate_Sword:
	ld a, (_RAM_C540+object.is_initialized)
	or a
	jp nz, +
	ld a, $04
	ld (_RAM_C578), a
...
+:
	...
	ld (_RAM_C54F), a
	ld a, $01
	ld (_RAM_C540+object.is_initialized), a
_LABEL_4E4B:
	call _LABEL_1C8C
	call ApplyObjectXVelocity
	ld a, (_RAM_C540+object.x_position_major)
...
HandleObject_Shield_Ra_Goan:
	ld a, (_RAM_C580+object.is_initialized)
	or a
	jp nz, ++
	ld a, $02
	ld (_RAM_C5B8), a
...
+:
	...
	ld (_RAM_C580), a
	ld a, $01
	ld (_RAM_C580+object.is_initialized), a
	ld hl, $ADA0
	ld (_RAM_C584), hl
	ld a, (_RAM_C500+object.x_position_minor)
	add a, $10
